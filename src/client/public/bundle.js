...
var _Heroes = __webpack_require__(28);
...
var App = function App() {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(_Heroes2.default, {
            wiem: 'wiem'
        })
    );
};
...
var Heroes = function (_Component) {
    ...
    function Heroes(props) {
        ...
        var _this = _possibleConstructorReturn(this, (Heroes.__proto__ || Object.getPrototypeOf(Heroes)).call(this, props));

        _this.boundFunc = function () {
            var REQ_URL = "https://api.opendota.com";
            var REQ_OPTIONS = {
                method: "GET",
                mode: "cors"
            };
            fetch(REQ_URL + "/api/heroStats", REQ_OPTIONS).then(function (res) {
                return res.json();
            }).then(function (data) {
